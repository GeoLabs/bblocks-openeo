...
# Apply dimension (Schema)

`ogc.openeo.processes.cubes.apply_dimension` *v0.1*
...
### Example 1
Calling `apply_dimension` with these arguments returns `{}`.
...
description: Apply a process to all values along a dimension
type: object
properties:
  data:
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/GeoLabs/bblocks-openeo/undefined/build/annotated/openeo/processes/cubes/apply_dimension/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/GeoLabs/bblocks-openeo/undefined/build/annotated/openeo/processes/cubes/apply_dimension/schema.yaml)

## Sources

* [OpenEO Processes — apply_dimension](https://processes.openeo.org/#apply_dimension)
* [Open-EO/openeo-processes — apply_dimension.json (2.0.0-rc.2)](https://github.com/Open-EO/openeo-processes/blob/2.0.0-rc.2/apply_dimension.json)
...
* Path: `_sources/processes/cubes/apply_dimension`
